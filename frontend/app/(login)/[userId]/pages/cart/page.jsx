          ...
          <div className="flex-1 bg-white p-6 rounded-md shadow ">
            ...
            <div className="quantity-input mb-4">
              ...
              <input
                ...
                onKeyDown={(e) => handleQuantityChange(e, productId)}
                className="mt-1 p-2 border border-gray-300 rounded-md w-full"
              />
              <p className="mt-2">
                Total Harga:{" "}
            ...
            {confirmationProductId === productId && (
              <p className="confirmation-message text-green-500">
            ...
            <div className="fixed bottom-0 left-0 right-0 h-16 bg-gray-200 border border-gray-300 p-4 flex justify-between items-center shadow">
              <div className="w-1/2 pr-4">
                <div className="flex justify-between items-center">
                  ...
                  <p className="block text-sm font-medium text-gray-700 w-1/2 align-right ">
                    {totalQuantity}
                  </p>
                </div>
                <div className="flex justify-between items-center">
                  <label
                  className="block text-sm font-medium text-gray-700 text-bold "
                  >Total Harga</label>
                  <p
                  className="block text-sm font-medium text-gray-700 align-right text-bold w-1/2 "
                  >
                    {new Intl.NumberFormat("id-ID", {
                      style: "currency",
                      currency: "IDR",
